...
class ForgeGameProfileIdentityTest {
    @Test
    void onlineModeGameProfileIdentityConvertsToDomainWithoutThrowing() {
        ...
        ForgeRuntime.GameProfileIdentity profile = new ForgeRuntime.GameProfileIdentity(onlineMojangUuid, username);
    ...
    void offlineModeGameProfileIdentityConvertsToDomain() {
        ...
        ForgeRuntime.GameProfileIdentity profile = new ForgeRuntime.GameProfileIdentity(offlineUuid, username);
        PlayerIdentity identity = profile.toDomain();
    ...
    void invalidUsernameThrowsValidationException() {
        ...
        ForgeRuntime.GameProfileIdentity profile = new ForgeRuntime.GameProfileIdentity(randomUuid, "invalid name with spaces");
