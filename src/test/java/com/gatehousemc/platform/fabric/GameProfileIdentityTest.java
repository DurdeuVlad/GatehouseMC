...
class GameProfileIdentityTest {
    ...
    void onlineModeGameProfileIdentityConvertsToDomainWithoutThrowing() {
        ...
        FabricRuntime.GameProfileIdentity profile = new FabricRuntime.GameProfileIdentity(onlineMojangUuid, username);
    ...
    void offlineModeGameProfileIdentityConvertsToDomain() {
        ...
        FabricRuntime.GameProfileIdentity profile = new FabricRuntime.GameProfileIdentity(offlineUuid, username);
        PlayerIdentity identity = profile.toDomain();
    ...
    void invalidUsernameThrowsValidationException() {
        ...
        FabricRuntime.GameProfileIdentity profile = new FabricRuntime.GameProfileIdentity(randomUuid, "invalid name with spaces");
